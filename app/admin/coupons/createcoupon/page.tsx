"use client";
import { CustomDateFormat } from "@/components/DatePicker/DatePicker";
    ...
    <>
      ...
      <div className=" bg-gray-100 flex items-center justify-center">
        <div className="container">
          <div>
            <div className="bg-white rounded shadow-lg md:p-8 mb-2">
              <div className="grid gap-4 gap-y-2 text-sm grid-cols-1 lg:grid-cols-3">
                <div className="lg:col-span-2">
                  <div className="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">
                    <div className="md:col-span-5">
                      <label htmlFor="full_name">Coupon Code</label>
                      <input
                        type="text"
                        name="full_name"
                        id="full_name"
                    ...
                    <div className="md:col-span-3">
                      <div className="flex justify-between">
                        <CustomDateFormat label="Valid From" />
                        <CustomDateFormat label="Valid Till" />
                      </div>
                    </div>
                    {/* <div className="md:col-span-2">
                    <label htmlFor="state">Minimum Order Value</label>
                    ...
                    <div className="md:col-span-1">
                      <label htmlFor="zipcode">Minimum Order Value</label>
                      <input
                        type="text"
                        name="zipcode"
                        id="zipcode"
