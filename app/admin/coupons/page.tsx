"use client";
import { ICoupons } from "@/constants/interface";

const CouponList = () => {
  const dummyCoupons: ICoupons[] = [
    {
      id: 1,
      code: "SUMMER50",
      minOrder: 100,
        ...
        {couponData.map((coupon) => (
          ...
          >
            <div>
              ...
              <p>Discount Amount: {coupon.disAmount}</p>
              <p>Active: {coupon.active ? "Yes" : "No"}</p>
              <p>Usage: {coupon.usuage} times</p>
              <p>
